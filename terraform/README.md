...
```
curl "https://nubesgen.com/alaz-ws.zip?iactool=TERRAFORM&region=eastus&application=APP_SERVICE.free&runtime=DOCKER&database=POSTGRESQL.basic&gitops=true" | tar -xzvf -
```
